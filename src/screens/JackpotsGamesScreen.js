...
class Jackpots extends React.Component {
  ...
  constructor(props){
    ...
    // Getting the feed from the url and setting the third category as dataSource
    getData() {
      return fetch('https://apiuat.casino.com/lobby/gamefeeds/au/mobile/notflix/?env=stg')
        ...
        .then((responseJson) => {
          ...
          this.setState({
            ...
            isLoading: false,
            dataSource: responseJson.feed.category[2].games,
          }, function(){
...
export default class JackpotsGamesScreen extends React.Component {
  // Setting the tab label
  static navigationOptions = {
    tabBarLabel: 'Jackpots',
  };
  render() {
    return <Navigation/>;
  }

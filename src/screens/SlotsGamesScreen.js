...
class Slots extends React.Component {
  ...
  constructor(props){
    ...
    // Getting the feed from the url and setting the first category as dataSource
    getData() {
      return fetch('https://apiuat.casino.com/lobby/gamefeeds/au/mobile/notflix/?env=stg')
        ...
        .then((responseJson) => {
          ...
          this.setState({
            ...
            isLoading: false,
            dataSource: responseJson.feed.category[0].games,
          }, function(){
    ...
    render() {
      ...
      // !!!IMPORTANT!!! This works only in this tab and I don't know why
...
export default class SlotsGamesScreen extends React.Component {
  // Setting the tab label
  static navigationOptions = {
    tabBarLabel: 'Slots Games',
  };
  render() {
    return <Navigation/>;
  }
